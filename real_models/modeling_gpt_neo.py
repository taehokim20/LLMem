...
class GPTNeoModel(GPTNeoPreTrainedModel):
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            g = GPUtil.getGPUs()[local_rank].memoryUsed
        ...
        print('[cuda:{}][GPTNeoModel -> forward]: {} // {} -> {} -> {} -> {} -> {}'.format(local_rank, g, k, l, m, n, o))
...
class GPTNeoForCausalLM(GPTNeoPreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            print('[cuda:{}][before lm_logits]: {} -> {} -> {} -> {} -> {}'.format(local_rank, a, b, c, d, e))
        ...
        print('[cuda:{}][GPTNeoForCausalLM -> forward]: {} -> {} -> {} -> {} -> {} -> {}'.format(local_rank, a, b, c, d, e, g))
